...
int dynarray_isempty(struct dynarray* da);                  //An
void* dynarray_head(struct dynarray* da);                   //An
void dynarray_enqueue(struct dynarray* da, void* val);      //An
void* dynarray_dequeue(struct dynarray* da);                //An
